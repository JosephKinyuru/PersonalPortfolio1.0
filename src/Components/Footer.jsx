        ...
        <footer>
          ...
          <section className='footerSection'>
            <ul className='socials'>
              <li><a href='https://www.instagram.com/jos3ph.kinyuru/' target='_blank' rel='noopener noreferrer'><i className="fa-brands fa-instagram "></i></a></li>
              <li><a href='https://twitter.com/josephk1nyuru' target='_blank' rel='noopener noreferrer'><i className="fa-brands fa-x-twitter"></i></a></li>
              <li><a href='https://www.linkedin.com/in/joseph-kinyuru-650bb129b/' target='_blank' rel='noopener noreferrer'><i className="fa-brands fa-linkedin "></i></a></li>
